...
export default class Main extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: {
        about:
          "I am a Research Assistant at AGenCy Lab @IUB. I received my Bachelor of Science degree in \
        ...
        publications: [
          {
            id: 1,
            title:
              'A.B.S Nayeem, A Sarkar, A.A Ali, M.A. Amin, A.K.M Rahman, "LULC Segmentation of RGB Satellite \
        ...
        skills: [
          ...
          { id: 5, type: "Web & Mobile App Development", name: "NodeJS" },
          {
            ...
            name: "Tensorflow, PyTorch, Keras",
          },
          {
            id: 7,
            type: "Framework/Libraries",
            name:
              "Numpy, Matplotlib, Seaborn, OpenCV, Scipy, Scikit-learn, Pillow, Pandas",
          },
